...
const CardHolidays = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_HOLIDAYS');
        ...
        {!loading &&
          holidays.map((item, index) => (
            ...
            >
              ...
              >
                <Link
                  href={`/holidays/holidays-view/?id=${item.id}`}
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    onDelete={onDelete}
                    itemId={item.id}
                    pathEdit={`/holidays/holidays-edit/?id=${item.id}`}
                    pathView={`/holidays/holidays-view/?id=${item.id}`}
