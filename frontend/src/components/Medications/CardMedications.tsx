...
const CardMedications = ({
  ...
  const hasUpdatePermission = hasPermission(currentUser, 'UPDATE_MEDICATIONS');
        ...
        {!loading &&
          medications.map((item, index) => (
            ...
            >
              ...
              >
                <Link
                  href={`/medications/medications-view/?id=${item.id}`}
                ...
                <div className='ml-auto '>
                  <ListActionsPopover
                    onDelete={onDelete}
                    itemId={item.id}
                    pathEdit={`/medications/medications-edit/?id=${item.id}`}
                    pathView={`/medications/medications-view/?id=${item.id}`}
