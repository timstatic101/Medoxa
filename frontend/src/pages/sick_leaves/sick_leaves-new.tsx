...
import { create } from '../../stores/sick_leaves/sick_leavesSlice';
...
Sick_leavesNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_SICK_LEAVES'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Sick_leavesNew;
