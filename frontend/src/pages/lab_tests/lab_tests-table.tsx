...
const Lab_testsTablesPage = () => {
  ...
  const hasCreatePermission =
    currentUser && hasPermission(currentUser, 'CREATE_LAB_TESTS');
  ...
  const getLab_testsCSV = async () => {
    ...
    link.download = 'lab_testsCSV.csv';
    link.click();
  };
  ...
  return (
    <>
      <Head>
        <title>{getPageTitle('Lab_tests')}</title>
      </Head>
      <SectionMain>
        ...
        <CardBox className='mb-6' cardBoxClassName='flex flex-wrap'>
          ...
          <div className='md:inline-flex items-center ms-auto'>
            ...
            <Link href={'/lab_tests/lab_tests-list'}>
...
Lab_testsTablesPage.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default Lab_testsTablesPage;
