...
const EditLab_tests = () => {
  ...
  const { lab_testsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: lab_testsId }));
  }, [lab_testsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: lab_testsId, data }));
...
EditLab_tests.getLayout = function getLayout(page: ReactElement) {
  return (
