...
const EditLab_order_items = () => {
  ...
  const { lab_order_itemsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: lab_order_itemsId }));
  }, [lab_order_itemsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: lab_order_itemsId, data }));
...
EditLab_order_items.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditLab_order_items;
