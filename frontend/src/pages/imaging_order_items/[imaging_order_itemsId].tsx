...
const EditImaging_order_items = () => {
  ...
  const { imaging_order_itemsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: imaging_order_itemsId }));
  }, [imaging_order_itemsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: imaging_order_itemsId, data }));
...
EditImaging_order_items.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditImaging_order_items;
