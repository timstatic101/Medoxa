...
const EditInvoice_items = () => {
  ...
  const { invoice_itemsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: invoice_itemsId }));
  }, [invoice_itemsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: invoice_itemsId, data }));
...
EditInvoice_items.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditInvoice_items;
