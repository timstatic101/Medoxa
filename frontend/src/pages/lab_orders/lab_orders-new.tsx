...
import { create } from '../../stores/lab_orders/lab_ordersSlice';
...
Lab_ordersNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_LAB_ORDERS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Lab_ordersNew;
