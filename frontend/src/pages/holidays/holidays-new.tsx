...
import { create } from '../../stores/holidays/holidaysSlice';
...
HolidaysNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_HOLIDAYS'}>
      {page}
    </LayoutAuthenticated>
  );
};
