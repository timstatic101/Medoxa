...
export const departmentsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(deleteItemsByIds.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, 'Departments has been deleted');
    });
    ...
    builder.addCase(deleteItem.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, `${'Departments'.slice(0, -1)} has been deleted`);
    });
    ...
    builder.addCase(create.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, `${'Departments'.slice(0, -1)} has been created`);
    });
    ...
    builder.addCase(update.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, `${'Departments'.slice(0, -1)} has been updated`);
    });
    ...
    builder.addCase(uploadCsv.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, 'Departments has been uploaded');
    });
...
export const { setRefetch } = departmentsSlice.actions;
