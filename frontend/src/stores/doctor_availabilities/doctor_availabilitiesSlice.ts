...
export const uploadCsv = createAsyncThunk(
  'doctor_availabilities/uploadCsv',
...
export const doctor_availabilitiesSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(fetch.fulfilled, (state, action) => {
      if (action.payload.rows && action.payload.count >= 0) {
        state.doctor_availabilities = action.payload.rows;
        state.count = action.payload.count;
      } else {
        state.doctor_availabilities = action.payload;
      }
      state.loading = false;
    });
    ...
    builder.addCase(deleteItemsByIds.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, 'Doctor_availabilities has been deleted');
    });
    ...
    builder.addCase(deleteItem.fulfilled, (state) => {
      ...
      fulfilledNotify(
        state,
        `${'Doctor_availabilities'.slice(0, -1)} has been deleted`,
      );
    });
    ...
    builder.addCase(create.fulfilled, (state) => {
      ...
      fulfilledNotify(
        state,
        `${'Doctor_availabilities'.slice(0, -1)} has been created`,
      );
    });
    ...
    builder.addCase(update.fulfilled, (state) => {
      ...
      fulfilledNotify(
        state,
        `${'Doctor_availabilities'.slice(0, -1)} has been updated`,
      );
    });
    ...
    builder.addCase(uploadCsv.fulfilled, (state) => {
      state.loading = false;
      fulfilledNotify(state, 'Doctor_availabilities has been uploaded');
    });
...
export const { setRefetch } = doctor_availabilitiesSlice.actions;

export default doctor_availabilitiesSlice.reducer;
